...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
   <head>
      ...
      <meta name="title" content="kawasan-berikat.com | Informasi, Peraturan & Manajemen Kawasan Berikat">
      <meta name="description" content="Menurut Peraturan Direktur Jenderal Bea dan Cukai Nomor PER-19/BC/2018, Kawasan Berikat adalah tempat penimbunan untuk barang impor dan/atau barang lokal dalam daerah pabean guna diolah atau digabungkan sebelum ekspor atau impor untuk dipakai. Kawasan ini mendapat fasilitas kepabeanan dan perpajakan seperti penangguhan bea masuk dan pembebasan PPN.">
      <meta name="keywords" content="kawasan berikat,kawasan berikat adalah,ppn kawasan berikat,peraturan kawasan berikat,berikat,berikat adalah,pengertian kawasan berikat,tujuan kawasan berikat,dasar hukum untuk kawasan berikat,kepabeanan,barang impor,fasilitas kepabeanan">
                     ...
                     <ul class="navbar-nav ms-auto">
                        {{-- <li class="nav-item dropdown">
                           ...
                           <ul class="dropdown-menu" style="min-width: 220px;">
                              <li><a class="dropdown-item" href="https://aplikasi.indonesiacore.com" >Aplikasi Android & iOS</a></li>
                              <li><a class="dropdown-item" href="https://apk.indonesiacore.com" >APK</a></li>
                              <li><a class="dropdown-item" href="https://googleplay.indonesiacore.com" >Play Store</a></li>
                              <li><a class="dropdown-item" href="https://aplikasipenghasiluang.indonesiacore.com" >Aplikasi Penghasil Uang</a></li>
                           </ul>
                        </li> --}}
                        {{-- <li class="nav-item dropdown">
                           <a class="nav-link dropdown-toggle font-bold" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                           ...
                           <ul class="dropdown-menu" style="min-width: 220px;">
                              <li><a class="dropdown-item" href="https://gudangberikat.com">{{ __('navbar.subnav_1_1') }}</a></li>
                              <li><a class="dropdown-item" href="https://pusatlogistikberikat.com/">{{ __('navbar.subnav_1_2') }}</a></li>
                              <li><a class="dropdown-item" href="https://kitepembebasan.com/">{{ __('navbar.subnav_1_3') }}</a></li>
                              <li><a class="dropdown-item" href="https://itinventorybeacukai.com/">{{ __('navbar.subnav_1_4') }}</a></li>
                              <li><a class="dropdown-item" href="https://kawasan-berikat.com">{{ __('navbar.subnav_1_5') }}</a></li>
                           </ul>
                        </li>
                        <li class="nav-item ">
