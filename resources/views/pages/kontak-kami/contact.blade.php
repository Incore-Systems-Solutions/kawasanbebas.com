...
@section('meta')
   ...
   <!-- Meta Item -->
    ...
    <title>{{ $meta['meta'][$lang]['title'] ?? 'Hubungi Kami = Kawasan-berikat.com' }}</title>
    <meta name="description" content="{{ $meta['meta'][$lang]['description'] ?? 'Hubungi tim kami untuk konsultasi kawasan berikat, pengurusan perizinan, dan solusi logistik industri. Kami siap membantu kebutuhan bisnis Anda.' }}">
    <meta name="keywords" content="{{ $meta['meta'][$lang]['keywords'] ?? 'kontak kawasan berikat, hubungi konsultan, layanan bea cukai, konsultasi logistik, izin kawasan industri, bantuan ekspor impor' }}">
   <!-- Schema Item -->
    {{-- Schema Item --}}
